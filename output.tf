output "id" {
  ...
  value       = aws_fsx_windows_file_system.default[count.index].id
}

output "arn" {
  description = "Amazon Resource Name of the file system."
  value       = aws_fsx_windows_file_system.default[count.index].arn
}
...
output "dns_name" {
  ...
  value       = aws_fsx_windows_file_system.default[count.index].dns_name
}

output "preferred_file_server_ip" {
  description = "The IP address of the primary, or preferred, file server."
  value       = aws_fsx_windows_file_system.default[count.index].preferred_file_server_ip
}
...
output "remote_administration_endpoint" {
  ...
  value       = aws_fsx_windows_file_system.default[count.index].remote_administration_endpoint
}