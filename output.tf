output "id" {
  ...
  value       = aws_fsx_windows_file_system.default.id[count.index]
}

output "arn" {
  description = "Amazon Resource Name of the file system."
  value       = aws_fsx_windows_file_system.default.arn[count.index]
}
...
output "dns_name" {
  ...
  value       = aws_fsx_windows_file_system.default.dns_name[count.index]
}

output "preferred_file_server_ip" {
  description = "The IP address of the primary, or preferred, file server."
  value       = aws_fsx_windows_file_system.default.preferred_file_server_ip[count.index]
}
...
output "remote_administration_endpoint" {
  ...
  value       = aws_fsx_windows_file_system.default.remote_administration_endpoint[count.index]
}